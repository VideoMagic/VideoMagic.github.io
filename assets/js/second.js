var enjoyhint_steps = [
    ...
    { // 5
        "click .chatroom-utterances-wrapper.evidence" : "특정 메시지 위에 마우스를 두면, 우측에 <b>'후보 등록'</b> 버튼이 나타납니다.<br>'후보 등록' 버튼을 <b>클릭</b>해서 이 메시지를 원인 후보로 올려보세요!",
        showSkip: false,
        onBeforeStart: function() {
...
enjoyhint_steps_moderator[4]["next .chatroom-container"] = enjoyhint_steps_moderator[4]["next .chatroom-container"].concat("<br>문제 원인에 대한 토의가 이루어지고 있네요.");
